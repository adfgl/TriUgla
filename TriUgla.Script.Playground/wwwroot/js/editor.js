window.editorInterop = {
    ...
    sourceOffsetAt(editor, clientX, clientY) {
        ...
        if (!this._fontMeasureCanvas) this._fontMeasureCanvas = document.createElement("canvas");
    ...
    syncScroll(editor) {
        ...
        if (lineNumbers) lineNumbers.style.transform = `translate3d(0, ${-editor.scrollTop}px, 0)`;
