...
{
    public sealed class ExprUnitsPreviewVisitor : IExprVisitor<Dim?>
    {
        public ExprUnitsPreviewVisitor(ScopeStack stack, Source source, Diagnostics diagnostics)
        {
            ScopeStack = stack;
            Source = source;
        ...
        public ExprEvaluateVisitor Evaluator { get; set; }
        ...
        static bool TryGetIntegerExponent(Expr expr, ExprEvaluateVisitor eval, out int p)
        {
            p = 0;
